...
interface RaceFaqsManagementProps {
  raceId: string;
}
...
export default function RaceFaqsManagement({ raceId }: RaceFaqsManagementProps) {
  const [faqs, setFaqs] = useState<RaceFaq[]>([]);
  ...
  const saveFaqs = async () => {
    setSaving(true);
    try {
      // Delete all existing FAQs for this race
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Preguntas Frecuentes de la Carrera</CardTitle>
      </CardHeader>
