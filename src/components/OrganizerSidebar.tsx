import { Calendar, Users, Home, Trophy, Timer, Route, HelpCircle, FolderOpen } from "lucide-react";
...
const menuItems = [
  ...
  { title: "FAQs de mi Carrera", view: "faqs" as OrganizerView, icon: HelpCircle },
];
