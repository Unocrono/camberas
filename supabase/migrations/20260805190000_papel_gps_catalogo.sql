...
--   mototv       → moto de GRAFISMO/TV (overlay; lecturas muy seguidas).
--                  OJO: las motos enlace NO son esto → organizacion
--   organizacion → policía, protección civil, médico, motos enlace
...
ALTER TABLE race_motos
  ADD COLUMN IF NOT EXISTS gps_role text NOT NULL DEFAULT 'mototv'
  CHECK (gps_role IN ('mototv', 'organizacion', 'voluntario'));
