-- Actualizar process_event_results para usar get_race_category
...
BEGIN
  ...
  -- 3. Calcular posiciones por CATEGORÍA usando get_race_category (categorías personalizadas)
...
-- Actualizar calculate_split_positions para usar get_race_category
...
BEGIN
  ...
  -- 3. Calcular posición por CATEGORÍA usando get_race_category (categorías personalizadas)
  WITH ranked_category AS (
    SELECT 
      st.id as split_id,
      ROW_NUMBER() OVER (
