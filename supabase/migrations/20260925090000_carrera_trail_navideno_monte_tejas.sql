...
-- el panel): fecha 13-12-2026 (confirmada por el usuario),
-- edición «II», precio 13 € (confirmado por la organización) y cupo (200); plazo 1 nov – 7 dic y devolución hasta el 2 dic, trasladados de la I edición (6 y 11 días antes).
--
...
BEGIN
  ...
  INSERT INTO public.races (
    ...
    'Carrera navideña, pequeña y de fiesta: 15 km por las sendas y caminos mitológicos del Monte Tejas, en San Felices de Buelna. Doce gnomos escondidos en el monte con premio, premios a los mejores disfraces (también en grupo) y música y ambiente en salida y meta.',
    'trail', 'carrera', '2026-12-13',
  ...
  INSERT INTO public.race_distances (
    ...
    v_dist, v_race, 'Trailvideño 15 km', 15, 730, 724, 13, 200,
  ...
  -- Devolución íntegra hasta el 2 de diciembre (11 días antes)
  ...
  IF v_reg IS NULL THEN
    ...
    INSERT INTO public.race_regulation_sections (regulation_id, section_type, title, content, is_required, section_order) VALUES
      ...
      (v_reg, 'registration', 'Inscripciones y participación', E'Cupo máximo: 200 corredores. Plazo: desde las 20:00 h del 1 de noviembre hasta las 24:00 h del 7 de diciembre de 2026, o hasta completar dorsales.\n\nPrecio: 13 € (incluye el seguro de accidentes del día de la prueba, taza y calcetines conmemorativos). La inscripción da derecho a todos los avituallamientos (incluido el de meta), comida al finalizar, sorteos, asistencia sanitaria, bolsa del corredor y dorsal, trofeos y premios y la cobertura de los seguros contratados.\n\nEdad mínima: 16 años cumplidos el día anterior a la prueba. Las inscripciones son personales e intransferibles.\n\nParticipar implica aceptar este reglamento, conocer las características técnicas de la prueba y estar preparado para ellas, y asumir que en plena naturaleza la seguridad depende de la capacidad del corredor para resolver los problemas previsibles.', true, 3),
  ...
  IF NOT EXISTS (SELECT 1 FROM public.race_faqs WHERE race_id = v_race) THEN
    INSERT INTO public.race_faqs (race_id, question, answer, display_order) VALUES
      ...
      (v_race, '¿Qué pasa con los gnomos?', 'Hay doce escondidos por el recorrido. Si encuentras uno, llévalo hasta meta (solo uno por persona) y sabrás qué premio te corresponde.', 4),
      (v_race, '¿Hay que ir disfrazado?', 'No es obligatorio, pero es la gracia de la carrera: hay premio a los tres mejores disfraces y, este año, al mejor disfraz de grupo.', 5),
      (v_race, '¿Hasta cuándo puedo pedir la devolución?', 'Hasta el 2 de diciembre incluido se devuelve íntegra. Después solo se admiten cambios de titular.', 6);
  END IF;
  ...
  INSERT INTO public.race_web (race_id, plantilla, activa, tema, contenido) VALUES (
    ...
    $json$
    {
      ...
      "fechaTexto": "Domingo 13 de diciembre de 2026",
      ...
      "inscripcion": {
        "cierreTexto": "Del 1 de noviembre a las 20:00 al 7 de diciembre, o hasta agotar los 200 dorsales",
        "edadMinima": 16,
        "incluye": ["Taza y calcetines conmemorativos", "Dorsal con chip y bolsa del corredor", "Seguro de accidentes del día de la prueba y responsabilidad civil", "Avituallamientos en carrera y en meta", "Comida al finalizar la prueba", "Asistencia sanitaria en carrera y en meta", "Participación en los sorteos", "Opción a trofeos y premios"],
        "nota": "Edad mínima: 16 años cumplidos el día anterior a la prueba.",
        "devolucion": {"hasta": "2026-12-02", "texto": "Devolución íntegra hasta el 2 de diciembre incluido. Después solo se admiten cambios de titular. Las inscripciones son personales e intransferibles."}
      },
      "reglamento": {
      ...
      "programa": [
        ...
        {"fecha": "2026-12-13", "hora": "10:30", "titulo": "Salida Trailvideño 15 km", "lugar": "Plaza del Ayuntamiento"},
      ...
      "dorsales": {"lugar": "Plaza del Ayuntamiento de San Felices de Buelna (zona de salida)", "horarios": [["Domingo 13 de diciembre", "08:30–10:00"]], "nota": "Imprescindible documento de identidad y, si la tienes, tarjeta federativa. Puede recogerlo otra persona con foto de tu DNI o una autorización con nombre y DNI."},
      "premios": [
        {"categoria": "Gnomos", "premio": "12 premios", "texto": "Doce gnomos escondidos semi-visibles por el recorrido. Quien encuentre uno lo lleva hasta meta (solo uno por persona). El premio de cada gnomo se desvela al darse la salida. Coger dos o más, o cambiarlos de sitio, es eliminación."},
        {"categoria": "Disfraces", "premio": "3 premios", "texto": "A los tres mejores disfraces de la prueba; el jurado es la organización."},
        {"categoria": "Disfraz grupal", "premio": "Novedad", "texto": "Al mejor disfraz de grupo: venid varios con una temática común."},
      ...
      "servicios": [
        ...
        {"nombre": "Ambiente de fiesta", "texto": "Música y animación en salida y meta. Ven disfrazado: hay premio individual y de grupo.", "icono": "fiesta"}
      ],
