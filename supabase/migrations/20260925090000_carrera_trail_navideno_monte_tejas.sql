...
-- edición «II», mismos precio (10 €) y cupo (200); plazo 1 nov – 7 dic y devolución hasta el 2 dic, trasladados de la I edición (6 y 11 días antes).
--
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM public.race_faqs WHERE race_id = v_race) THEN
    INSERT INTO public.race_faqs (race_id, question, answer, display_order) VALUES
      ...
      (v_race, '¿Hasta cuándo puedo pedir la devolución?', 'Hasta el 2 de diciembre incluido se devuelve íntegra. Después solo se admiten cambios de titular.', 5);
  END IF;
