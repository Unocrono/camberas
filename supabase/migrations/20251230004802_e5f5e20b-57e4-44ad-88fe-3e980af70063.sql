-- Actualizar la función de seed para incluir campo category como Sistema de solo lectura
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM registration_form_fields WHERE race_distance_id = p_distance_id AND is_system_field = true) THEN
    ...
    VALUES
      ...
      (p_distance_id, 'category', 'Categoría', 'readonly', 8, false, true, true, NULL, NULL),
